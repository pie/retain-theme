...
<!-- FAQ Section -->
    <section class="faq" id="faq">
        ...
        <div class="collapsible-wrapper">
            ...
            <div class="content">
            <p>
                    No. The current individual ticket price is the one displayed on this page and is the lowest at the time of publication.</p>
                    ...
                    <p><strong>Group Bookings:</strong> If you have a group of 10 or more people that want to attend, please feel free to reach out to us directly for more information on a group discount.
                </p>
            </div>
            ...
            <div class="content">
            <p>
                    You can cancel at any time, but please be aware of the following policy: If you cancel before March 31st 2025 you will receive a full refund, less any processing fees.</p>
            ...
            <div class="content">
            <p>
                    Lunch will be provided, along with a light breakfast and refreshments throughout the day.</p>
...
<?php endif; ?>
    ...
    ?>
<!-- Tickets Section -->
    <section class="tickets" id="tickets" style="margin-top:50px;">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/tickets/tickets-icon.png" alt="Tickets icon" class="icon-img">
...
<footer style="background: black; margin-top:40px;color:white;padding:20px;width:100%; text-align: center;">
    <p style="color:white;">Copyright &copy; 2025 - We Do Digital Ltd | <a href="https://www.retainlive.com/affiliate-home" style="color:white;">Affiliates</a> | <a href="https://www.retainlive.com/sponsorship/" style="color:white;">Sponsorship</a></p>
</footer>
</main>
